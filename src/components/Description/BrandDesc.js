...
const BrandDesc = ({
    ...
    const selectData = [
        { name: "manufacturerId", value: 'id', option: 'name', action: getManufacturers, store: 'manufacturers', lable: 'Change manufacturer', required: false, mode: false },
        { name: "brandId", value: 'id', option: 'name', action: getBrands, store: 'brands', lable: 'Change brand', required: false, mode: false, brandSelect: true },
    ]
    ...
    const onFinishEdit = (values) => {
        editBrand(values, manufacturerId, id)
    }
        ...
        <Styles>
            ...
            <div className="item-wrapper">
                <div className="description-box">
                    ...
                    {
                        manufacture &&
                        <div className="title-item-desc">Manufacture: <span>{manufacture.name}</span></div>
                    }
                ...
                <div className="controls-box">
                    <Popconfirm
                        ...
                        title={`Are you sure you want to delete brand ${name}？`} okText="Yes" cancelText="No">
            ...
            <Tabs defaultActiveKey={params.tab} onChange={callback}>
                ...
                <TabPane
                    tab="Core Products"
                    key="coreProduct"
                    disabled={coreProducts && coreProducts.length === 0}
                >
                    <ProductsTable
                        status={status}
