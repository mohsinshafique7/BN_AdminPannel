      ...
      <div className="item-wrapper">
        ...
        <div className="controls-box">
          <Popconfirm
            ...
            title={`Are you sure you want to delete source category ${name}？`}
            okText="Yes"
            cancelText="No"
          >
          ...
          <CoreForm title={"Edit source category"} initialValue={initialValue} inputData={inputData} onSendForm={onSendForm} />
        </div>
      </div>
    </>
  );
